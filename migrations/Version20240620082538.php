 ...
 */
final class Version20240620082538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, project_name VARCHAR(255) NOT NULL, creation_date DATE NOT NULL, modification_date DATE NOT NULL, client_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2FB3D0EE19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
