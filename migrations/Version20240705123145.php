...
final class Version20240705123145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD user_id INT DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, ADD client_name VARCHAR(255) DEFAULT NULL, CHANGE name project_name VARCHAR(255) NOT NULL');
